---
layout: article
title: ML I / Part I. Machine Learning - 1.The Introduction to the Machine Learning
key: 0
tags: ml
category: ml concept
...
2. [Supervised Learning](/2018/03/31/tcp-ip-book-index-2/#2장-네트워크-서비스와-애플리케이션-계층)
3. [Unsupervised Learning](/2018/03/31/tcp-ip-book-index-3/#3장-트랜스포트-계층)
4. [Reinforcement Learning](/2018/04/01/tcp-ip-book-index-4/#4장-라우팅과-인터넷-계층)
...
​
#### 3.1.  Supervised Learning(지도 학습)과 Unsupervised Learning(자율 학습, 비지도 학습)  
​
...
- 자율학습의 대표적인 2가지 예는 분류(clustering)과 차원 축소(dimensionality reduction)이다.
  - ​차원 축소의 기술로는 PCA(Principle Component Analysis), ICA(Independent Component Analysis), Non-negative matrix factorization 및 SVD(Singlular Value Decomposition) 기술 등이 있다. 이것들 각각에 대한 자세한 내용은 추후에 다룰 예정이다.
...
​
​
### 4. Unsupervised Learning (자율 학습, 비지도 학습)
